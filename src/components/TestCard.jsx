    ...
    <>
      ...
      >
        ...
        {/* <Card
          name="— Prateek"
          desgination="Saaskart, Saas Company"
          desc="We threw some wild ideas at AV Technosys, and they turned them into features we didn’t even know we needed! Fast, efficient, and a blast to work with."
          profileImg={user2}
          className="photo"
        /> */}
      </Marquee>
...
const Card = ({ desc, name, desgination, profileImg }) => {
  return (
    <div className="bg-[#1c1c1e]  fontTest py-10 overflow-hidden">
      <div class="lg:flex lg:h-[325px] h-72 lg:w-[60vw] w-[130vw]  overflow-hidden lg:mx-10 mx-4 p-4 border-2 rounded-3xl  ">
        <div className="lg:w-[60%] w-[50%] ">
          <p className="text-white text-wrap leading-6  overflow-hidden lg:text-[1rem] lg:font-medium text-xs p-4 mt-5">
            <FormatQuoteIcon className="-mt-3 -ml-3 rotate-180" />
            {desc}
            <FormatQuoteIcon className="-mt-3 lg:mr-3 mr-0" /> <br />
          </p>
        </div>
        ...
        <div class="relative lg:w-[40%]  lg:-mt-0 -mt-44 lg:ml-0 ml-64  h-72 flex justify-center rounded-2xl items-center   overflow-hidden">
          ...
          <img src={profileImg} alt="" className="lg:mt-0 mt-5" />
            
        </div>
        <div className="bg-[#1c1c1e] size-fit absolute top-52  overflow-hidden">
          <h1 className="text-white lg:text-xl text-md font-medium pt-4 pl-4">
            {name}
          </h1>
