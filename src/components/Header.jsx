...
const Header = () => {
  ...
  return (
    <div className="">
      <div className="fontTest overflow-hidden bg-[#1c1c1e] p-6">
          ...
          <div className="w-full flex ">
            ...
            <div className="w-3/4 h-24 bg-white pt-4 rounded-t-[35px]">
              <div className="mx-20 -mt-4 ">
                <ul className="flex gap-5 cursor-pointer flex-wrap list-none justify-center mt-5 p-3 text-lg font-medium  border-[1.5px] border-black rounded-full">
                  <li className="pr-4">
            ...
            <div className="w-1/4   h-24 bg-white">
              <div className=" flex bg-[#1c1c1e] w-full h-full rounded-bl-[35px] text-white">
        ...
        className={`fixed top-0 right-0 h-full ml-[1000px] transform ${isOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-300 ease-in-out z-40 flex`}> */}
                      ...
                      <div className="relative h-full flex flex-row">
                        ...
                        <div className="p-6 flex-1 w-[850px] bg-white text-black overflow-y-auto ">
                          ...
                          <h1 className=" p-3 mt-5 ml-2 font-medium text-sm">
                          ...
                          <form action="">
                            ...
                            <div>
                              <select
                                className="border justify-start  pr-72 py-2 mt-8 ml-6 font-medium"
                                name=""
                                id=""
                              >
                            ...
                            <textarea
                              className="ml-6 mt-8 text-sm font-normal border pr-[285px] pb-16 "
                              placeholder="   Message"
                            ></textarea>
