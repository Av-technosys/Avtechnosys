...
const Form1 = () => {
  return (
    ...
    <form action='#'>
        <div className='flex flex-col md:flex-row justify-center md:justify-around gap-7 md:gap-16 lg:gap-30 mt-8 md:mt-12 px-4'>
            <input
                type='text'
        ...
        <div className='mt-10 lg:mt-24 md:mt-16 px-4 lg:ml-28'>
            <input
                type='text'
                placeholder='Tell us about your business and scope of the project'
                className='bg-transparent border-b-2 border-b-gray-200 outline-none text-lg md:text-3xl lg:text-4xl pb-4 md:pb-6 text-white placeholder-white w-full lg:w-[91%] '
            />
        </div>
        <div className='mt-14 lg:mt-20 flex justify-end lg:mr-36 '>
            <button
                className='bg-white text-lg md:text-xl lg:text-2xl font-semibold py-6 w-full md:w-auto lg:px-3 md:px-12 rounded-lg'
            >
                Get in Touch
            </button>
        </div>
