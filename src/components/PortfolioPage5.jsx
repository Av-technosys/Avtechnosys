    ...
    <>
      ...
      <div className=" bg-[#1c1c1e] lg:overflow-hidden pb-10 ">
        ...
        <div className=" flex justify-between w-full lg:pt-10">
          ...
          />
          <img src={finz1} alt="" className="lg: -ml-40 " />
        </div>
        <div className="text-white h-24 lg:ml-14 ml-4 lg:w-[50%] lg:-mt-80 -mt-20  ">
          ...
          <p className="lg:text-[1rem]  lg:font-normal mt-7 ">
            Finz introduces subscription-based payment cards to revolutionize
            financial transactions. Finz cards offer mersonalized memberships
            enhancing financial management and rewarding users with, exclusive
            cashback, discounts and perks.
          </p>
        ...
        <div className="flex lg:mt-72 mt-44 text-white   lg:ml-14 ml-4">
          ...
          <div className="lg:text-[32px] text-xl font-semibold  lg:ml-0 ml-10">
            {" "}
            Solutions
            <h1 className="lg:mt-6 mt-2 lg:text-[24px] font-normal">
              {" "}
              Customer App / Web
            </h1>
          ...
          <div className="flex ">
            <ul className="mt-5 lg:text-[1rem] text-lg lg:w-[36vw] w-[70vw] ">
              ...
              <li className="lg:w-[60vw]">
                ...
                <span className="">
                  {" "}
                  Contact Form 7 Small Ballon Instagram Feed, Site Kit
                </span>
              </li>
