  ...
  return (
    <>
      ...
      <div className="fontTest flex h-96 bg-[#1c1c1e] ">
        <div className=" ml-10 h-9 w-3 pr-1 bg-white rounded-tl-3xl rounded-br-3xl">
          {" "}
        </div>
        ...
        <div className="lg:pl-56 text-white">
          <h1 className="lg:text-3xl text-xl font-bold">Cloud Transformation</h1>
      ...
      <div className=" fontTest flex lg:h-72 h-60 lg:-mt-36 -mt-20 lg:-mb-0  bg-[#1c1c1e] ">
        ...
        <div className=" lg:ml-48 mb-48 mr-3   h-52  w-80 overflow-hidden justify-center items-center">
