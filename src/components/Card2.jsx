  ...
  return (
    <>
      <div className="fontTest bg-[#1c1c1e] text-white ">
        <h1 className="text-white lg:text-[4rem] font-semibold text-2xl pt-[4rem] lg:pl-[5.5rem] pl-5">
          Why AV Technosys?
        </h1>
    ...
    <div class="fontTest group flex lg:-mt-[3.5rem] -mt-5 m-5 lg:py-24 py-10 w-full items-center justify-center">
      <div class="relative flex h-[300px] w-[250px]">
        ...
        <div class="absolute -bottom-2 flex flex-col gap-4 h-[251px] w-full items-center justify-center rounded-b-lg border-x border-b text-white">
          <span class="text-[1.3rem] duration-500 translate-y-10 group-hover:-translate-y-5">
            {Cardtitle}
          </span>
          <p className=" text-[1rem] text-center px-[5%]  opacity-0 group-hover:opacity-100 duration-500 translate-y-6 group-hover:translate-y-0">
            {" "}
            {Carddata}
          </p>
        </div>
