  ...
  return (
    <>
      <header className="  fontTest text-white flex flex-wrap justify-between  h-32 w-full bg-[#1c1c1e]">
        ...
        <div
          className="lg:hidden absolute right-5 top-14 "
          onClick={togglemenu}
        >
          <MenuIcon
            sx={{
        ...
        <div className=" lg:flex hidden ml-28 my-11">
          ...
          <div className="flex border ml-6 mr-3 px-3 rounded-lg ">
            ...
            <div className="p-6 flex-1 w-[850px]   bg-white text-black overflow-y-auto overflow-x-hidden ">
              ...
              <form action="">
                <div className=" flex ml-3  gap-20">
                  <input
                    className="border py-1 bg-white"
                    type="text"
                    placeholder="  Name*"
                  />
                  <input
                ...
                <textarea
                  className="ml-3 mt-8 text-sm bg-white font-normal border pr-[285px] pb-16 "
                  placeholder="   Message"
                ></textarea>
