  ...
  return (
    <>
      ...
      <div className="fontTest bg-[#1c1c1e] lg:h- h-">
        <h1 className="text-white lg:text-[4rem] text-[2rem] font-semibold  lg:p-16 md:p-20 p-16">
          Latest Articles
        </h1>
        <div className="">
          <div className=" lg:flex">
            ...
            <div className=" flex  lg:mt-0 mt-2 lg:ml-0 ml-5 ">
              ...
              />
              <img
                className="size-5 lg:mt-0 mt-2 -ml-5 "
                src={search}
                alt="search icon"
              />
            </div>
          ...
          <div className="flex mt-10 lg:ml-14 ml-16  flex-wrap gap-10">
            {filteredBlogs.map((blog) => (
              <div
                key={blog.keyword}
                className="flex flex-col gap-2 rounded-lg p-4 w-64 relative"
              >
