...
import Xamarianlogo from "../Assets/xamarin.svg";
...
import openkartlogo from "../Assets/opencart.svg";
...
const Tabs = () => {
  ...
  return (
    <div className="bg-[#1c1c1e] text-white px-[5.5rem] h-[80vh]">
      {/* Tabs */}
      <div className="flex list-none cursor-pointer justify-between text-white text-[1rem] font-semibold">
        {tabs.map((tab, index) => (
          <li
            key={index}
      ...
      <div className=" justify-between ">
        {activeTab === 0 && (
          <div className='grid grid-cols-6 gap-4 '>
            <div className="flex gap-3 mt-[56px]">
       ...
       <div className="flex gap-3 mt-[56px]">
        ...
        {activeTab === 6 && (
          ...
          <div className="flex gap-3 mt-[56px]">
            ...
            <h1 className='mt-3'>{tabs[activeTab].content}Salesforce Commerce Cloud</h1>
          </div>
          ...
          <div className="flex gap-3 mt-[56px]">
            ...
            <h1 className='mt-3'>{tabs[activeTab].content}Angular Commerce</h1>
          </div>
          <div className="flex gap-3 mt-[56px]">
